...
//START:GET_ROUTE_HANDLE
  ...
  it("get / handler should call model's all & returns result", function(done) {
...
//START:GET_ID2
  it("get /:validid handler should call model's get & returns a task", function(done) {
...
//END:GET_ID2
//START:GET_ID3
  it("get /:invalidid handler should call model's get & returns {}", function(done) {
    var sampleTask = {};
...
//END:POST1
//START:POST2
  it("post / handler should call model's add & returns success message", function(done) {
    var sampleTask = {name: 't1', month: 12, day: 1, year: 2016};
...
//END:DELETE1
//START:DELETE2
  it("delete /:validid handler should call model's delete, returns success", function(done) {
...
//END:DELETE2
//START:DELETE3
  it("delete /:invalidid handler should return error message", function(done) {
    sandbox.stub(task, 'delete', function(id, callback) {
      expect(id).to.be.eql(req.params.id);
